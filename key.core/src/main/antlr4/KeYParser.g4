...
elementary_update_term: elementary_state_update_term | mc_update_term;
elementary_state_update_term: a=equivalence_term (ASSIGN b=equivalence_term)?;
mc_update_term: MC_UPDATE LPAREN mc=equivalence_term COMMA heap=equivalence_term RPAREN;
...
update_term: (LBRACE u=parallel_term RBRACE) (atom_prefix | unary_formula | mc_update_term);
